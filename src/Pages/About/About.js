            ...
            <div class="hero min-h-screen ">
                <div class="hero-content flex-col lg:flex-row-reverse justify-center items-center">
                    ...
                    <div className='grid grid-cols-2 gap-5 '>
                            ...
                            <ul className=''>
                                <li className='link'>1.	https://groca-grocery.web.app</li>
                                <li className='link'>2.  https://dentist-rita.web.app</li>
                                <li className='link'>3.  https://motor-parts-bd.web.app</li>
